...
<?php echo $this->Form->create('Make'); ?>
	<fieldset>
		<legend><?php echo __('Edit Make'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Make.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Make.id')))); ?></li>

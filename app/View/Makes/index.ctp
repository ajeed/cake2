<div class="makes index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $make['Make']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $make['Make']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $make['Make']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $make['Make']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
